...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" --git-dir=.git show-ref "67e6070f9d9a44b4dec79ebe6b591f39d2285593"
  WORKING_DIRECTORY "D:/Projects/GD-Roulette/build/_deps/json-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Projects/GD-Roulette/build/_deps/json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Projects/GD-Roulette/build/_deps/json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
